...
#pragma warning disable SYSLIB0011 // BinaryFormatter used for existing .bin file format (legacy serialization layer)
using System;
					...
					try
					{
						...
						if (RVersion == SerializerVersion)
						{
							...
							if (REncrypted && Password == null)
							{
								...
								{
									string NewKey = "" /* Phase 4: prompt user for password */;
									if ((NewKey != null))
									{
										FinalStream.Close();

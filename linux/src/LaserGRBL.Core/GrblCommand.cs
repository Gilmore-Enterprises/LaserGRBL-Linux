...
using LaserGRBL.CSV;
// System.Drawing and LaserGRBL.Obj3D removed: Color → CoreColor, Object3DDisplayList → IDisplayList.
...
namespace LaserGRBL
{
	public interface IGrblRow
	{
		...
		CoreColor LeftColor { get; }
		CoreColor RightColor { get; }
	...
	public static class CSVD
	{
		...
		public static void LoadAppropriateCSV(GrblVersionInfo value)
		{
		...
		private static void LoadAppropriateSettings(GrblVersionInfo value)
		{
			try
			{
				string ResourceName;
		...
		private static void LoadAppropriateAlarms(GrblVersionInfo value)
		{
			try
			{
				string ResourceName;
		...
		private static void LoadAppropriateErrors(GrblVersionInfo value)
		{
			try
			{
				string ResourceName;
	...
	public partial class GrblCommand : ICloneable, IGrblRow, IDisposable
	{
        ...
        public IDisplayList LinkedDisplayList { get; internal set; } = null;
		...
		public CoreColor LeftColor
		{ get { return ColorScheme.LogLeftCOMMAND; } }

		public CoreColor RightColor
	...
	public class GrblMessage : IGrblRow
	{
		...
		public CoreColor RightColor
		{ get { return CoreColor.Black; } } //normalmente per questi messaggi non c'è un right
